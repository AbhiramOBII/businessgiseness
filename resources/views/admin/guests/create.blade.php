...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex items-center mb-8">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Add New Guest</h1>
            <p class="text-gray-600 mt-2">Create a new podcast guest profile</p>
        </div>
    </div>

    <!-- Form -->
    <form method="POST" action="{{ route('admin.guests.store') }}" enctype="multipart/form-data" class="max-w-4xl">
        @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="short_description" 
                                  ...
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('short_description') border-red-500 @enderror">{{ old('short_description') }}</textarea>
        ...
        <div class="flex justify-end space-x-4 mt-6">
            ...
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i>Create Guest
            </button>
        </div>
    </form>
</div>
...
document.getElementById('photo').addEventListener('change', function(e) {
    ...
    if (file) {
        ...
        preview.innerHTML = '<i class="fas fa-user text-gray-600 text-2xl"></i>';
    }
});
