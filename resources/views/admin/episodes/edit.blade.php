...
@section('page-description', 'Update episode information')
...
<div class="max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        <form action="{{ route('admin.episodes.update', $episode) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               required>
                        <p class="text-sm text-gray-500 mt-1">Used in the episode URL. Should be unique and URL-friendly.</p>
                        @error('slug')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               id="youtube_link" 
                               name="youtube_link" 
                               value="{{ old('youtube_link', $episode->youtube_link) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-gold focus:border-brand-gold transition-colors duration-200"
                    ...
                    <div>
                        ...
                        <textarea id="short_description" 
                                  ...
                                  maxlength="500"
                                  required>{{ old('short_description', $episode->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="long_description" 
                                  ...
                                  required>{{ old('long_description', $episode->long_description) }}</textarea>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div>
                    <label for="thumbnail" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $episode->thumbnail ? 'Replace Thumbnail' : 'Episode Thumbnail' }}
                    </label>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="meta_title" 
                               name="meta_title" 
                               value="{{ old('meta_title', $episode->meta_title) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-gold focus:border-brand-gold transition-colors duration-200"
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" 
                                  ...
                                  maxlength="500">{{ old('meta_description', $episode->meta_description) }}</textarea>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Update Episode
                </button>
            </div>
        </form>
    </div>
