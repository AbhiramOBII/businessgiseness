                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="short_description" 
                                  ...
                                  placeholder="Brief description for previews and SEO">{{ old('short_description') }}</textarea>
                    ...
                    <!-- Thumbnail -->
                    <div class="mb-6">
                        <label for="thumbnail" class="block text-sm font-medium text-gray-700 mb-2">Featured Image</label>
                        <input type="file" 
                               id="thumbnail" 
                               name="thumbnail" 
                               accept="image/*"
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="og_description" 
                                  ...
                                  placeholder="Defaults to short description">{{ old('og_description') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="twitter_description" 
                                  ...
                                  placeholder="Defaults to short description">{{ old('twitter_description') }}</textarea>
